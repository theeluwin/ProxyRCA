...
class BPRPPSolver(BaseBPRContrastiveSolver):
    ...
    def backup(self):
        ...
        copyfile('models/bprpp.py', f'{self.data_dir}/model.py')
        copyfile('solvers/bprpp.py', f'{self.data_dir}/solver.py')
