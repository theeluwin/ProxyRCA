...
class MixdimSolver(BaseLWPContrastiveSolver):
    ...
    def init_model(self) -> None:
        ...
        self.model = Mixdim(
            ...
            sparse_dim=CM['num_proxy_item'],
            num_dense_item=num_known_item,
    ...
    # override
    def backup(self):
        copyfile('models/encoders/mixdim.py', f'{self.data_dir}/encoder.py')
        copyfile('models/mixdim.py', f'{self.data_dir}/model.py')
        copyfile('solvers/mixdim.py', f'{self.data_dir}/solver.py')
