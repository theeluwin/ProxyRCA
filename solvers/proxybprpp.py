...
from models import ProxyBPRPP

from .base import BaseBPRContrastiveSolver
...
class ProxyBPRPPSolver(BaseBPRContrastiveSolver):
    ...
    def calculate_forward(self, batch):
        ...
        # device
        uindex = batch['uindex'].to(self.device)  # b
    ...
    def backup(self):
        ...
        copyfile('models/proxybprpp.py', f'{self.data_dir}/model.py')
        copyfile('solvers/proxybprpp.py', f'{self.data_dir}/solver.py')
