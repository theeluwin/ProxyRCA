...
class ProxyRCASolver(BaseLWPContrastiveSolver):
    ...
    def init_model(self) -> None:
        ...
        # num known item as float/integer
    ...
    def backup(self):
        ...
        copyfile('models/proxyrca.py', f'{self.data_dir}/model.py')
        copyfile('solvers/proxyrca.py', f'{self.data_dir}/solver.py')
